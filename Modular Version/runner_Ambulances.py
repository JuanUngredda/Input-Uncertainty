...
from IU_optimizer.utils import toysource as ambsource
from TestProblems.Ambulance_simulator import Ambulance_simulator as ambfun
...
myoptimizer = Multi_Input_Uncert(f=ambfun,
                                 xran=ambfun.xran,
                                 wran=ambfun.wran,
