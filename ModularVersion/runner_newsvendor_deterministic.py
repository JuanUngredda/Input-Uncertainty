...
from TestProblems.newsvendor import newsvendor_deterministic
...
"""
for rp in range(1):
    [XA], [Y], [Data] = myoptimizer( sim_fun = newsvendor_deterministic(), inf_src= toysource(lb =newsvendor_deterministic().amin,ub=newsvendor_deterministic().amax,d=1),
                          lb_x = newsvendor_deterministic().xmin, ub_x = newsvendor_deterministic().xmax,
                          lb_a = newsvendor_deterministic().amin, ub_a = newsvendor_deterministic().amax,
