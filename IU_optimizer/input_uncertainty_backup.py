...
def Mult_Input_Uncert():
    ...
    # def true_Q(a):
    #     # Compute average simulator over inputs.
    #     # ARGS
    #     #  a: an decision variable value
    #     # 
    #     # ASSUMED ARGS
    #     #  test_func: the true simulator    
    #     #
    #     # RETURNS
    #     #  F_a: average simulator output at a
    ...
    #     # Compute average gp model over inputs.
    #     # ARGS
    #     #  a: an decision variable value
    #     #  model: a gpy object
    #     #  Nx: int, number of points to MC integrate IU
    #     #
    #     # RETURNS
    #     #  F_x: model prediction at a
    ...
    #     # Compute average simulator over inputs.
    #     # ARGS
    #     #  X: a given set of IU values
    #     #  a: an decision variable value
    #     #  model: a gpy object
    #     #  Nx: unused
    #     #
    #     # RETURNS
    #     #  F_a: sun GP model outputs
    ...
    #     # Compute sum total prior covariance between (x_Nx,a) and (xan)
    #     # ARGS
    #     #  a: an decision variable value
    #     #  xan: n*d matrixa, a set of XxA points
    #     #  model: a gpy object
    #     #  Nx: int, IU MC sample size
    #     #
    #     # RETURNS
    #     #  SUM_COV: average prior covarince
    ...
    def Input_Source(n, s, mv_gen = True):
        ...
        if mv_gen == True:
            f_mean,f_cov = np.random.random(n)*(ub-lb)+lb, np.multiply(np.identity(n),var)
    ...
    def Fit_Inputs(Y =[]):
        # Computes MU and margs_mu form observations
        # 
        # ARGS
        #  Y: observations
        #
    ...
    def Gen_Sample(Dist, N=500):
        ...
        #
        # RETURNS
        #  val: samples from equally spaced intervals 0,..,100
    ...
    def sample_predict_dens(Data,N):
        # Generte samples from the haluciated future pmf
        #
        # ARGS
    ...
    def Delta_Loss(Data,idx):
        # Compute the improvment in payoff due to queerying the
        # info source
        #
        #
        global Nr,Nx
